...
sed -i 's/^PKG_VERSION:=.*/PKG_VERSION:=1.8.7/g' package/small/xray-core/Makefile
sed -i 's/^PKG_HASH:=.*/PKG_HASH:=e8f46177d792b89700f164ca28fbf1a3c7d95a3ecf98871cb0dd5e474b46a859/g' package/small/xray-core/Makefile
